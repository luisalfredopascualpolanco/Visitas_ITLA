...
CONSTRAINT CONTRASEÑA_UNICA UNIQUE(CONTRASEÑA)
)
...
AS
INSERT INTO USUARIOS VALUES (@NOMBRES,@APELLIDOS,@FECHA_DE_NACIMIENTO,@TIPO_DE_USUARIO,@NOMBRE_DE_USUARIO,@CONTRASEÑA)
...
@CONTRASEÑA NVARCHAR(50)
AS
SELECT TIPO_DE_USUARIO FROM USUARIOS WHERE NOMBRE_DE_USUARIO=@NOMBRE_DE_USUARIO AND CONTRASEÑA=@CONTRASEÑA
...
EXEC SP_INSERTAR_USUARIO 'UNIBE','ES LA CONTRASENA','1997/4/23','ADMINISTRADOR','UNIBE','6wXlaBzzw9a8x8InmOEMQqjA5gsGF/V/Q4oNza4IMQU='
